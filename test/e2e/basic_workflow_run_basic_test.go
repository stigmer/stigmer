...
// TestRunBasicWorkflow tests the complete workflow execution workflow:
...
func (s *E2ESuite) TestRunBasicWorkflow() {
	...
	execution := WaitForWorkflowExecutionCompletion(s.T(), s.Harness.ServerPort, runResult.ExecutionID, WorkflowExecutionTimeoutSeconds)
