...
class AgentStatus(_message.Message):
    __slots__ = ("audit", "default_instance_id", "share_link_token")
    ...
    def __init__(self, audit: _Optional[_Union[_status_pb2.ApiResourceAudit, _Mapping]] = ..., default_instance_id: _Optional[str] = ..., share_link_token: _Optional[str] = ...) -> None: ...
