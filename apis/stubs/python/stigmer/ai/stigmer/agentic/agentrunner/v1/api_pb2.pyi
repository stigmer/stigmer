...
from ai.stigmer.agentic.agentrunner.v1 import spec_pb2 as _spec_pb2
...
class AgentRunner(_message.Message):
    ...
    spec: _spec_pb2.AgentRunnerSpec
    status: AgentRunnerStatus
    def __init__(self, api_version: _Optional[str] = ..., kind: _Optional[str] = ..., metadata: _Optional[_Union[_metadata_pb2.ApiResourceMetadata, _Mapping]] = ..., spec: _Optional[_Union[_spec_pb2.AgentRunnerSpec, _Mapping]] = ..., status: _Optional[_Union[AgentRunnerStatus, _Mapping]] = ...) -> None: ...

class AgentRunnerStatus(_message.Message):
    __slots__ = ("audit", "phase", "task_queue", "last_heartbeat_at", "started_at", "stopped_at", "current_executions", "sandbox_id", "connection_info")
...
class AgentRunnerConnectionInfo(_message.Message):
    ...
    arch: str
    runner_version: str
    def __init__(self, hostname: _Optional[str] = ..., os: _Optional[str] = ..., arch: _Optional[str] = ..., runner_version: _Optional[str] = ...) -> None: ...
