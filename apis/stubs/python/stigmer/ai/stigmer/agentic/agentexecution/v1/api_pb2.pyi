...
class AgentExecutionStatus(_message.Message):
    __slots__ = ("audit", "messages", "phase", "sub_agent_executions", "error", "started_at", "completed_at", "todos", "callback_token", "usage", "resolved_context", "pending_approvals", "context_info", "artifacts", "workspace_write_backs", "setup_progress")
