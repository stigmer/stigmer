...
class AgentExecutionStatus(_message.Message):
    __slots__ = ("audit", "messages", "phase", "tool_calls", "sub_agent_executions", "error", "started_at", "completed_at", "todos", "callback_token", "usage", "resolved_context", "pending_approval", "context_info", "outputs")
...
class ToolCall(_message.Message):
    __slots__ = ("id", "name", "args", "result", "status", "component_metadata", "started_at", "completed_at", "error", "requires_approval", "approval_message", "approval_requested_at", "approval_decided_at", "approved_by", "approval_action")
    ID_FIELD_NUMBER: _ClassVar[int]
...
class ExecutionOutput(_message.Message):
    ...
    name: str
    sandbox_path: str
    kind: _enum_pb2.ExecutionOutputKind
    size_bytes: int
    storage_key: str
    download_url: str
    created_at: str
    expires_at: str
    def __init__(self, name: _Optional[str] = ..., sandbox_path: _Optional[str] = ..., kind: _Optional[_Union[_enum_pb2.ExecutionOutputKind, str]] = ..., size_bytes: _Optional[int] = ..., storage_key: _Optional[str] = ..., download_url: _Optional[str] = ..., created_at: _Optional[str] = ..., expires_at: _Optional[str] = ...) -> None: ...
