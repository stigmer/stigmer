...
class SlackInstallStatus(_message.Message):
    __slots__ = ("team_id", "team_name", "bot_user_id", "granted_scopes", "installer_slack_user_id", "installed_at")
    ...
    def __init__(self, team_id: _Optional[str] = ..., team_name: _Optional[str] = ..., bot_user_id: _Optional[str] = ..., granted_scopes: _Optional[_Iterable[str]] = ..., installer_slack_user_id: _Optional[str] = ..., installed_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
