...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'ai/stigmer/billing/subscription/v1/io.proto'
)
...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'ai.stigmer.billing.subscription.v1.io_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  _globals['DESCRIPTOR']._loaded_options = None
  _globals['DESCRIPTOR']._serialized_options = b'\n&com.ai.stigmer.billing.subscription.v1B\007IoProtoP\001\242\002\004ASBS\252\002\"Ai.Stigmer.Billing.Subscription.V1\312\002\"Ai\\Stigmer\\Billing\\Subscription\\V1\342\002.Ai\\Stigmer\\Billing\\Subscription\\V1\\GPBMetadata\352\002&Ai::Stigmer::Billing::Subscription::V1'
  _globals['_GETSUBSCRIPTIONFORORGANIZATIONINPUT'].fields_by_name['org_id']._loaded_options = None
  _globals['_GETSUBSCRIPTIONFORORGANIZATIONINPUT'].fields_by_name['org_id']._serialized_options = b'\272H\003\310\001\001'
  _globals['_GETENTITLEMENTSINPUT'].fields_by_name['org_id']._loaded_options = None
  _globals['_GETENTITLEMENTSINPUT'].fields_by_name['org_id']._serialized_options = b'\272H\003\310\001\001'
  _globals['_CHANGEPLANINPUT'].fields_by_name['org_id']._loaded_options = None
  _globals['_CHANGEPLANINPUT'].fields_by_name['org_id']._serialized_options = b'\272H\003\310\001\001'
  _globals['_CHANGEPLANINPUT'].fields_by_name['plan_id']._loaded_options = None
