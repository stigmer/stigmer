...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_IAMPOLICYCOMMANDCONTROLLER']._serialized_start=286
  _globals['_IAMPOLICYCOMMANDCONTROLLER']._serialized_end=983
