...
class OAuthAppSpec(_message.Message):
    __slots__ = ("provider", "client_id", "client_secret", "authorization_url", "token_url", "scopes", "userinfo_url", "scope_parameter_name", "vendor_approval_status", "vendor_approval_docs_url")
