...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_PLATFORMCLIENTSPEC']._loaded_options = None
  _globals['_PLATFORMCLIENTSPEC']._serialized_options = b'\272H\374\002\032\333\001\n2platform_client.auto_grant_requires_auto_provision\022lauto_grant_on_org requires auto_provision_accounts: only an account the client provisions receives the grant\0327!this.auto_grant_on_org || this.auto_provision_accounts\032\233\001\n)platform_client.auto_grant_role_not_owner\022Sauto_grant_role cannot be owner; organization ownership must be assigned explicitly\032\031this.auto_grant_role != 1'
  _globals['_PLATFORMCLIENTSPEC']._serialized_start=267
  _globals['_PLATFORMCLIENTSPEC']._serialized_end=1338
