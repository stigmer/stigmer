...
from ai.stigmer.iam.platformclient.v1 import spec_pb2 as _spec_pb2
...
class PlatformClient(_message.Message):
    ...
    spec: _spec_pb2.PlatformClientSpec
    status: PlatformClientStatus
    def __init__(self, api_version: _Optional[str] = ..., kind: _Optional[str] = ..., metadata: _Optional[_Union[_metadata_pb2.ApiResourceMetadata, _Mapping]] = ..., spec: _Optional[_Union[_spec_pb2.PlatformClientSpec, _Mapping]] = ..., status: _Optional[_Union[PlatformClientStatus, _Mapping]] = ...) -> None: ...

class PlatformClientStatus(_message.Message):
