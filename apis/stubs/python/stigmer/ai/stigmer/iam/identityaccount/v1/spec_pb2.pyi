...
class IdentityAccountPreferences(_message.Message):
    __slots__ = ("standing_context", "default_harness", "default_native_model", "default_cursor_model", "memory_enabled", "default_auto_approve")
    ...
    DEFAULT_AUTO_APPROVE_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, standing_context: _Optional[str] = ..., default_harness: _Optional[str] = ..., default_native_model: _Optional[str] = ..., default_cursor_model: _Optional[str] = ..., memory_enabled: bool = ..., default_auto_approve: bool = ...) -> None: ...
