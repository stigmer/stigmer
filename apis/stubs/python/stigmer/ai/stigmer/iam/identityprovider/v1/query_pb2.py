...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_IDENTITYPROVIDERQUERYCONTROLLER']._serialized_start=277
  _globals['_IDENTITYPROVIDERQUERYCONTROLLER']._serialized_end=615
