...
public interface GetAgentInstancesByAgentRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:ai.stigmer.agentic.agentinstance.v1.GetAgentInstancesByAgentRequest)
