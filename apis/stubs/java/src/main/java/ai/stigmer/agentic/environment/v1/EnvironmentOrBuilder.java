...
public interface EnvironmentOrBuilder extends
    // @@protoc_insertion_point(interface_extends:ai.stigmer.agentic.environment.v1.Environment)
   ...
   * <code>.ai.stigmer.agentic.environment.v1.EnvironmentSpec spec = 4 [json_name = "spec"];</code>
   */
  ai.stigmer.agentic.environment.v1.EnvironmentSpecOrBuilder getSpecOrBuilder();
