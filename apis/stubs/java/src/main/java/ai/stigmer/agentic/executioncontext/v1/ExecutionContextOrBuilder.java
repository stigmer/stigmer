...
public interface ExecutionContextOrBuilder extends
    // @@protoc_insertion_point(interface_extends:ai.stigmer.agentic.executioncontext.v1.ExecutionContext)
   ...
   * <code>.ai.stigmer.agentic.executioncontext.v1.ExecutionContextSpec spec = 4 [json_name = "spec"];</code>
   */
  ai.stigmer.agentic.executioncontext.v1.ExecutionContextSpecOrBuilder getSpecOrBuilder();
