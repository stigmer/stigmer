...
public enum RunnerPhase
  ...
  /**
   * <code>RUNNER_PHASE_UNSPECIFIED = 0;</code>
   */
   ...
   * </pre>
   *
   * <code>RUNNER_PHASE_PENDING = 1;</code>
   */
   ...
   * </pre>
   *
   * <code>RUNNER_PHASE_READY = 2;</code>
   */
   ...
   * </pre>
   *
   * <code>RUNNER_PHASE_STOPPED = 4;</code>
   */
   ...
   * <code>RUNNER_PHASE_UNSPECIFIED = 0;</code>
   */
  public static final int RUNNER_PHASE_UNSPECIFIED_VALUE = 0;
  /**
   * <pre>
   * Resource created but no heartbeat received yet.
   * This is the initial phase after create/apply, before the runner
   ...
   * <code>RUNNER_PHASE_PENDING = 1;</code>
   */
  public static final int RUNNER_PHASE_PENDING_VALUE = 1;
  /**
   * <pre>
   * Runner is heartbeating and accepting new executions.
   * </pre>
   ...
   * <code>RUNNER_PHASE_READY = 2;</code>
   */
  public static final int RUNNER_PHASE_READY_VALUE = 2;
  /**
   * <pre>
   * Runner is heartbeating but at maximum concurrent execution capacity.
   * New executions should not be dispatched to this runner.
   ...
   * <code>RUNNER_PHASE_BUSY = 3;</code>
   */
  public static final int RUNNER_PHASE_BUSY_VALUE = 3;
  /**
   * <pre>
   * Runner has stopped heartbeating (timeout) or was explicitly stopped.
   * The resource is retained for identity persistence — a runner that
   ...
   * <code>RUNNER_PHASE_STOPPED = 4;</code>
   */
  public static final int RUNNER_PHASE_STOPPED_VALUE = 4;
  /**
   * <pre>
   * Unrecoverable error. Runner or server reported a fatal condition.
   * Requires investigation; does not auto-recover on heartbeat.
  ...
  public static RunnerPhase valueOf(int value) {
   ...
   * @return The enum associated with the given numeric wire value.
   */
  public static RunnerPhase forNumber(int value) {
    switch (value) {
      case 0: return RUNNER_PHASE_UNSPECIFIED;
      case 1: return RUNNER_PHASE_PENDING;
      case 2: return RUNNER_PHASE_READY;
  ...
  public static com.google.protobuf.Internal.EnumLiteMap<RunnerPhase>
      internalGetValueMap() {
    return internalValueMap;
  }
  private static final com.google.protobuf.Internal.EnumLiteMap<
      RunnerPhase> internalValueMap =
        new com.google.protobuf.Internal.EnumLiteMap<RunnerPhase>() {
          public RunnerPhase findValueByNumber(int number) {
            return RunnerPhase.forNumber(number);
          }
        };
  ...
  public static com.google.protobuf.Descriptors.EnumDescriptor
      getDescriptor() {
    return ai.stigmer.agentic.runner.v1.EnumProto.getDescriptor().getEnumType(0);
  }

  private static final RunnerPhase[] VALUES = values();

  public static RunnerPhase valueOf(
  ...
  private RunnerPhase(int value) {
    this.value = value;
  }

  // @@protoc_insertion_point(enum_scope:ai.stigmer.agentic.runner.v1.RunnerPhase)
}
