...
const file_ai_stigmer_agentic_agent_v1_spec_proto_rawDesc = "" +
	"\n" +
	"&ai/stigmer/agentic/agent/v1/spec.proto\x12\x1bai.stigmer.agentic.agent.v1\x1a,ai/stigmer/agentic/environment/v1/spec.proto\x1a2ai/stigmer/commons/apiresource/field_options.proto\x1a'ai/stigmer/commons/apiresource/io.proto\x1a\x1bbuf/validate/validate.proto\"\xaf\x05\n" +
	"\tAgentSpec\x12 \n" +
	...
	"\x16mcp_server_usages.kind\x12?mcp_server_usages must reference resources with kind=mcp_server\x1a\x1ethis.mcp_server_ref.kind == 44R\x0fmcpServerUsages\x12\xc0\x01\n" +
	"\n" +
	"skill_refs\x18\x05 \x03(\v24.ai.stigmer.commons.apiresource.ApiResourceReferenceBk\xbaH_\x92\x01\\\"Z\xba\x01W\n" +
	"\x0fskill_refs.kind\x123skill_refs must reference resources with kind=skill\x1a\x0fthis.kind == 43\xe2\x85,\x05skillR\tskillRefs\x12D\n" +
	"\n" +
	"sub_agents\x18\x06 \x03(\v2%.ai.stigmer.agentic.agent.v1.SubAgentR\tsubAgents\x12M\n" +
	"\benv_spec\x18\a \x01(\v22.ai.stigmer.agentic.environment.v1.EnvironmentSpecR\aenvSpec\"\xff\x02\n" +
	"\bSubAgent\x12\x1a\n" +
	...
	"\n" +
	"mcp_access\x18\x04 \x03(\v2&.ai.stigmer.agentic.agent.v1.McpAccessR\tmcpAccess\x12\xc0\x01\n" +
	"\n" +
	"skill_refs\x18\x05 \x03(\v24.ai.stigmer.commons.apiresource.ApiResourceReferenceBk\xbaH_\x92\x01\\\"Z\xba\x01W\n" +
	"\x0fskill_refs.kind\x123skill_refs must reference resources with kind=skill\x1a\x0fthis.kind == 43\xe2\x85,\x05skillR\tskillRefs\"\x92\x02\n" +
	"\x0eMcpServerUsage\x12p\n" +
	"\x0emcp_server_ref\x18\x01 \x01(\v24.ai.stigmer.commons.apiresource.ApiResourceReferenceB\x14\xbaH\x03\xc8\x01\x01\xe2\x85,\n" +
	"mcp_serverR\fmcpServerRef\x12#\n" +
