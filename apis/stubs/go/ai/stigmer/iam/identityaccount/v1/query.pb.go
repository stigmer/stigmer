...
const file_ai_stigmer_iam_identityaccount_v1_query_proto_rawDesc = "" +
	...
	"\fgetActorInfo\x124.ai.stigmer.iam.identityaccount.v1.IdentityAccountId\x1a5.ai.stigmer.commons.apiresource.ApiResourceAuditActor\",¸\x18(\b\x03\x10\v*\"unauthorized to look up actor info\x1a\x04\xa0\xff+\vB\xba\x02\n" +
