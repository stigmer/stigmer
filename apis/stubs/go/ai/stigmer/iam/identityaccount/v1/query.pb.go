...
const file_ai_stigmer_iam_identityaccount_v1_query_proto_rawDesc = "" +
	...
	"\n" +
	"getByIdpId\x12(.ai.stigmer.iam.identityaccount.v1.IdpId\x1a2.ai.stigmer.iam.identityaccount.v1.IdentityAccount\"5¸\x181\b\x01\x10\v\"\x05value*$unauthorized to get identity account\x12\xa9\x01\n" +
	"\fgetActorInfo\x124.ai.stigmer.iam.identityaccount.v1.IdentityAccountId\x1a5.ai.stigmer.commons.apiresource.ApiResourceAuditActor\",¸\x18(\b\x01\x10\v*\"unauthorized to look up actor info\x1a\x04\xa0\xff+\vB\xba\x02\n" +
