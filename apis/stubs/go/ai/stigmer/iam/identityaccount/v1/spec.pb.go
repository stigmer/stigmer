...
type IdentityAccountPreferences struct {
	...
	// Empty means no preference — the platform default applies.
	DefaultNativeModel string `protobuf:"bytes,3,opt,name=default_native_model,json=defaultNativeModel,proto3" json:"default_native_model,omitempty"`
	// Default model (registry model ID) for cursor-harness sessions.
	// Empty means no preference — the platform default applies.
	DefaultCursorModel string `protobuf:"bytes,4,opt,name=default_cursor_model,json=defaultCursorModel,proto3" json:"default_cursor_model,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *IdentityAccountPreferences) GetDefaultHarness() string {
	if x != nil {
...
func (x *IdentityAccountPreferences) GetDefaultNativeModel() string {
	if x != nil {
		return x.DefaultNativeModel
	}
	return ""
}

func (x *IdentityAccountPreferences) GetDefaultCursorModel() string {
	if x != nil {
		return x.DefaultCursorModel
	}
	return ""
}
...
const file_ai_stigmer_iam_identityaccount_v1_spec_proto_rawDesc = "" +
	...
	"\vpreferences\x18\t \x01(\v2=.ai.stigmer.iam.identityaccount.v1.IdentityAccountPreferencesR\vpreferences\"\x8a\x02\n" +
	...
	"\x14default_cursor_model\x18\x04 \x01(\tB\a\xbaH\x04r\x02\x18dR\x12defaultCursorModelB\xb9\x02\n" +
