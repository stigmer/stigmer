...
const file_ai_stigmer_iam_identityprovider_v1_spec_proto_rawDesc = "" +
	"\n" +
	"-ai/stigmer/iam/identityprovider/v1/spec.proto\x12\"ai.stigmer.iam.identityprovider.v1\x1a\x1bbuf/validate/validate.proto\"\xf4\x01\n" +
	...
	"\x11rate_limit_budget\x18\x05 \x01(\x05R\x0frateLimitBudgetB\xc0\x02\n" +
