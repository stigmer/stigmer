...
const file_ai_stigmer_agentic_workflowexecution_v1_api_proto_rawDesc = "" +
	...
	"\x06status\x18\x05 \x01(\v2@.ai.stigmer.agentic.workflowexecution.v1.WorkflowExecutionStatusR\x06status\"\xe9\x03\n" +
	...
	"\x0ecallback_token\x18\v \x01(\fR\rcallbackToken\"\xf2\x03\n" +
