...
const file_ai_stigmer_agentic_workflowexecution_v1_query_proto_rawDesc = "" +
	...
	"\x0fsubscribeEvents\x12?.ai.stigmer.agentic.workflowexecution.v1.SubscribeEventsRequest\x1a?.ai.stigmer.agentic.workflowexecution.v1.WorkflowExecutionEvent\"N¸\x18J\b\x01\x104\"\fexecution_id*6unauthorized to subscribe to workflow execution events0\x01\x1a\x04\xa0\xff+4B\xe0\x02\n" +
