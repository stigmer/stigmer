...
var File_ai_stigmer_agentic_schedule_v1_query_proto protoreflect.FileDescriptor
...
const file_ai_stigmer_agentic_schedule_v1_query_proto_rawDesc = "" +
	...
	"\blistRuns\x127.ai.stigmer.agentic.schedule.v1.ListScheduleRunsRequest\x1a/.ai.stigmer.agentic.schedule.v1.ScheduleRunList\"9¸\x185\b\x01\x108\"\vschedule_id*\"unauthorized to list schedule runs\x1a\x04\xa0\xff+8B\xa1\x02\n" +
	"\"com.ai.stigmer.agentic.schedule.v1B\n" +
	"QueryProtoP\x01ZRgithub.com/stigmer/stigmer/apis/stubs/go/ai/stigmer/agentic/schedule/v1;schedulev1\xa2\x02\x04ASAS\xaa\x02\x1eAi.Stigmer.Agentic.Schedule.V1\xca\x02\x1eAi\\Stigmer\\Agentic\\Schedule\\V1\xe2\x02*Ai\\Stigmer\\Agentic\\Schedule\\V1\\GPBMetadata\xea\x02\"Ai::Stigmer::Agentic::Schedule::V1b\x06proto3"

var file_ai_stigmer_agentic_schedule_v1_query_proto_goTypes = []any{
...
func init() { file_ai_stigmer_agentic_schedule_v1_query_proto_init() }
func file_ai_stigmer_agentic_schedule_v1_query_proto_init() {
	if File_ai_stigmer_agentic_schedule_v1_query_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_ai_stigmer_agentic_schedule_v1_query_proto_rawDesc), len(file_ai_stigmer_agentic_schedule_v1_query_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_ai_stigmer_agentic_schedule_v1_query_proto_goTypes,
		DependencyIndexes: file_ai_stigmer_agentic_schedule_v1_query_proto_depIdxs,
	}.Build()
	File_ai_stigmer_agentic_schedule_v1_query_proto = out.File
	file_ai_stigmer_agentic_schedule_v1_query_proto_goTypes = nil
	file_ai_stigmer_agentic_schedule_v1_query_proto_depIdxs = nil
}
