...
// 	protoc        (unknown)
// source: ai/stigmer/management/project/v1/spec.proto
...
func (x *ProjectSpec) Reset() {
	*x = ProjectSpec{}
	mi := &file_ai_stigmer_management_project_v1_spec_proto_msgTypes[0]
...
func (*ProjectSpec) Descriptor() ([]byte, []int) {
	return file_ai_stigmer_management_project_v1_spec_proto_rawDescGZIP(), []int{0}
}
...
var File_ai_stigmer_management_project_v1_spec_proto protoreflect.FileDescriptor

const file_ai_stigmer_management_project_v1_spec_proto_rawDesc = "" +
	"\n" +
	"+ai/stigmer/management/project/v1/spec.proto\x12 ai.stigmer.management.project.v1\x1a'ai/stigmer/commons/apiresource/io.proto\"\xa0\x01\n" +
	"\vProjectSpec\x12\x1f\n" +
	"\ventry_point\x18\x01 \x01(\tR\n" +
	"entryPoint\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12N\n" +
	"\amembers\x18\x03 \x03(\v24.ai.stigmer.commons.apiresource.ApiResourceReferenceR\amembersB\xab\x02\n" +
	"$com.ai.stigmer.management.project.v1B\tSpecProtoP\x01ZSgithub.com/stigmer/stigmer/apis/stubs/go/ai/stigmer/management/project/v1;projectv1\xa2\x02\x04ASMP\xaa\x02 Ai.Stigmer.Management.Project.V1\xca\x02 Ai\\Stigmer\\Management\\Project\\V1\xe2\x02,Ai\\Stigmer\\Management\\Project\\V1\\GPBMetadata\xea\x02$Ai::Stigmer::Management::Project::V1b\x06proto3"

var (
	file_ai_stigmer_management_project_v1_spec_proto_rawDescOnce sync.Once
	file_ai_stigmer_management_project_v1_spec_proto_rawDescData []byte
)

func file_ai_stigmer_management_project_v1_spec_proto_rawDescGZIP() []byte {
	file_ai_stigmer_management_project_v1_spec_proto_rawDescOnce.Do(func() {
		file_ai_stigmer_management_project_v1_spec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_ai_stigmer_management_project_v1_spec_proto_rawDesc), len(file_ai_stigmer_management_project_v1_spec_proto_rawDesc)))
	})
	return file_ai_stigmer_management_project_v1_spec_proto_rawDescData
}

var file_ai_stigmer_management_project_v1_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_ai_stigmer_management_project_v1_spec_proto_goTypes = []any{
	(*ProjectSpec)(nil),                      // 0: ai.stigmer.management.project.v1.ProjectSpec
	(*apiresource.ApiResourceReference)(nil), // 1: ai.stigmer.commons.apiresource.ApiResourceReference
}
var file_ai_stigmer_management_project_v1_spec_proto_depIdxs = []int32{
	1, // 0: ai.stigmer.management.project.v1.ProjectSpec.members:type_name -> ai.stigmer.commons.apiresource.ApiResourceReference
...
func init() { file_ai_stigmer_management_project_v1_spec_proto_init() }
func file_ai_stigmer_management_project_v1_spec_proto_init() {
	if File_ai_stigmer_management_project_v1_spec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_ai_stigmer_management_project_v1_spec_proto_rawDesc), len(file_ai_stigmer_management_project_v1_spec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_ai_stigmer_management_project_v1_spec_proto_goTypes,
		DependencyIndexes: file_ai_stigmer_management_project_v1_spec_proto_depIdxs,
		MessageInfos:      file_ai_stigmer_management_project_v1_spec_proto_msgTypes,
	}.Build()
	File_ai_stigmer_management_project_v1_spec_proto = out.File
	file_ai_stigmer_management_project_v1_spec_proto_goTypes = nil
	file_ai_stigmer_management_project_v1_spec_proto_depIdxs = nil
}
