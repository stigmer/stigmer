...
Core schema reference for the `agentic.stigmer.ai/v1` Project resource. For conceptual overview and the apply workflow, see [README.md](README.md).
...
All spec fields are defined by `ProjectSpec` in `ai/stigmer/agentic/project/v1/spec.proto`.
