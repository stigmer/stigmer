...
create an Organization: a fresh stack has none yet. Leave it there for a moment;
the next two steps create one from the CLI so you see both paths. Download links
the platform mints point at port 7235.
