...
// All implementations should embed UnimplementedWorkflowRunnerServiceControllerServer
...
// UnimplementedWorkflowRunnerServiceControllerServer should be embedded to have
...
func (UnimplementedWorkflowRunnerServiceControllerServer) PauseExecution(context.Context, *PauseExecutionRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PauseExecution not implemented")
}
...
func RegisterWorkflowRunnerServiceControllerServer(s grpc.ServiceRegistrar, srv WorkflowRunnerServiceControllerServer) {
	// If the following call pancis, it indicates UnimplementedWorkflowRunnerServiceControllerServer was
