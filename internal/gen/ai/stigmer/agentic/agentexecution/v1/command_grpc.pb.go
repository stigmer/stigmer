...
// All implementations must embed UnimplementedAgentExecutionCommandControllerServer
...
// UnimplementedAgentExecutionCommandControllerServer must be embedded to have
...
func (UnimplementedAgentExecutionCommandControllerServer) mustEmbedUnimplementedAgentExecutionCommandControllerServer() {
}
...
func RegisterAgentExecutionCommandControllerServer(s grpc.ServiceRegistrar, srv AgentExecutionCommandControllerServer) {
	// If the following call panics, it indicates UnimplementedAgentExecutionCommandControllerServer was
