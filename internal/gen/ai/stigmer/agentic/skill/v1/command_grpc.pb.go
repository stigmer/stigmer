...
// All implementations must embed UnimplementedSkillCommandControllerServer
...
// UnimplementedSkillCommandControllerServer must be embedded to have
...
func (UnimplementedSkillCommandControllerServer) mustEmbedUnimplementedSkillCommandControllerServer() {
}
...
func RegisterSkillCommandControllerServer(s grpc.ServiceRegistrar, srv SkillCommandControllerServer) {
	// If the following call panics, it indicates UnimplementedSkillCommandControllerServer was
