...
// All implementations must embed UnimplementedWorkflowInstanceCommandControllerServer
...
// UnimplementedWorkflowInstanceCommandControllerServer must be embedded to have
...
func (UnimplementedWorkflowInstanceCommandControllerServer) mustEmbedUnimplementedWorkflowInstanceCommandControllerServer() {
}
...
func RegisterWorkflowInstanceCommandControllerServer(s grpc.ServiceRegistrar, srv WorkflowInstanceCommandControllerServer) {
	// If the following call panics, it indicates UnimplementedWorkflowInstanceCommandControllerServer was
