...
type OrganizationInput struct {
	...
	Description string `json:"description,omitempty" jsonschema:"description=description for the organization"`
	// public url for the organization logo (optional)
	LogoUrl string `json:"logo_url,omitempty" jsonschema:"description=public url for the organization logo (optional)"`
