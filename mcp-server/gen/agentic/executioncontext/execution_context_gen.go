...
type ExecutionContextInput struct {
	...
	ExecutionId string `json:"execution_id,omitempty" jsonschema:"description=The execution ID this context belongs to. This is typically a WorkflowExecution ID or AgentExecution ID."`
	...
	Data map[string]*ExecutionValue `json:"data,omitempty" jsonschema:"description=Key-value pairs containing both configuration and secrets. These are provided at runtime and only exist for the duration of the execution. Example: {'AWS_ACCESS_KEY_ID': {value: 'AKIA...', is_secret: true}}"`
}
