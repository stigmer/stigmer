...
type WorkflowInstanceInput struct {
	...
	// Reference to the Workflow template this instance deploys. This links the instance to a reusable orchestration blueprint. The Workflow defines which AgentInstances to orchestrate and in what order. Format: Workflow resource ID (e.g., "wfl_abc123") Validation: Minimum length of 1 character (required field) Example: "wfl_abc123" (references a Workflow named "deploy-to-cloud")
