...
type HttpCallTaskConfigInput struct {
	...
	Method string `json:"method" jsonschema:"HTTP method (GET, POST, PUT, DELETE, PATCH)."`
...
type SignalInput struct {
	...
	Type string `json:"type" jsonschema:"Signal type: - 'signal': Temporal signal - 'query': Temporal query - 'update': Temporal update"`
}
...
type ListenToInput struct {
	...
	Mode string `json:"mode" jsonschema:"Listening mode: - 'one': Wait for any one signal - 'all': Wait for all signals"`
...
type WorkflowTaskInput struct {
	...
	Kind string `json:"kind" jsonschema:"Task type. Set the matching config field (e.g. kind='http_call' -> populate http_call)."`
