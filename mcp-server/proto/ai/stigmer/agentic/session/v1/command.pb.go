...
const file_ai_stigmer_agentic_session_v1_command_proto_rawDesc = "" +
	...
	"\x06delete\x12(.ai.stigmer.agentic.session.v1.SessionId\x1a&.ai.stigmer.agentic.session.v1.Session\"N¸\x18J\b\x1a\x10\x1f*;unauthorized to delete session — operator access required2\astigmer\x1a\x04\xa0\xff+*B\x9f\x02\n" +
