...
const file_ai_stigmer_agentic_session_v1_command_proto_rawDesc = "" +
	...
	"\x06delete\x12(.ai.stigmer.agentic.session.v1.SessionId\x1a&.ai.stigmer.agentic.session.v1.Session\"/¸\x18+\b\x03\x10*\"\x05value*\x1eunauthorized to delete session\x1a\x04\xa0\xff+*B\x9f\x02\n" +
