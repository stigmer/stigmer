...
const file_ai_stigmer_agentic_mcpserver_v1_command_proto_rawDesc = "" +
	...
	"\x1cupdateDiscoveredCapabilities\x12B.ai.stigmer.agentic.mcpserver.v1.UpdateDiscoveredCapabilitiesInput\x1a*.ai.stigmer.agentic.mcpserver.v1.McpServer\"G¸\x18C\b\x04\x10,\"\rmcp_server_id*.unauthorized to update mcp server capabilities\x1a\x04\xa0\xff+,B\xad\x02\n" +
...
var file_ai_stigmer_agentic_mcpserver_v1_command_proto_depIdxs = []int32{
	...
	0, // 11: ai.stigmer.agentic.mcpserver.v1.McpServerCommandController.updateDiscoveredCapabilities:output_type -> ai.stigmer.agentic.mcpserver.v1.McpServer
