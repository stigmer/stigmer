...
func (x *Skill) Reset() {
	*x = Skill{}
	mi := &file_ai_stigmer_agentic_skill_v1_api_proto_msgTypes[0]
...
func (*Skill) Descriptor() ([]byte, []int) {
	return file_ai_stigmer_agentic_skill_v1_api_proto_rawDescGZIP(), []int{0}
}
...
func (x *Skill) GetMetadata() *apiresource.ApiResourceMetadata {
	if x != nil {
		return x.Metadata
	}
	return nil
...
var File_ai_stigmer_agentic_skill_v1_api_proto protoreflect.FileDescriptor
...
const file_ai_stigmer_agentic_skill_v1_api_proto_rawDesc = "" +
	...
	"\x05items\x18\x03 \x03(\v2\".ai.stigmer.agentic.skill.v1.SkillR\x05itemsB\x8d\x02\n" +
	"\x1fcom.ai.stigmer.agentic.skill.v1B\bApiProtoP\x01ZOgithub.com/stigmer/stigmer/mcp-server/proto/ai/stigmer/agentic/skill/v1;skillv1\xa2\x02\x04ASAS\xaa\x02\x1bAi.Stigmer.Agentic.Skill.V1\xca\x02\x1bAi\\Stigmer\\Agentic\\Skill\\V1\xe2\x02'Ai\\Stigmer\\Agentic\\Skill\\V1\\GPBMetadata\xea\x02\x1fAi::Stigmer::Agentic::Skill::V1b\x06proto3"

var (
	file_ai_stigmer_agentic_skill_v1_api_proto_rawDescOnce sync.Once
	file_ai_stigmer_agentic_skill_v1_api_proto_rawDescData []byte
)

func file_ai_stigmer_agentic_skill_v1_api_proto_rawDescGZIP() []byte {
	file_ai_stigmer_agentic_skill_v1_api_proto_rawDescOnce.Do(func() {
		file_ai_stigmer_agentic_skill_v1_api_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_ai_stigmer_agentic_skill_v1_api_proto_rawDesc), len(file_ai_stigmer_agentic_skill_v1_api_proto_rawDesc)))
	})
...
func file_ai_stigmer_agentic_skill_v1_api_proto_init() {
	if File_ai_stigmer_agentic_skill_v1_api_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_ai_stigmer_agentic_skill_v1_api_proto_goTypes,
		DependencyIndexes: file_ai_stigmer_agentic_skill_v1_api_proto_depIdxs,
		MessageInfos:      file_ai_stigmer_agentic_skill_v1_api_proto_msgTypes,
	}.Build()
	File_ai_stigmer_agentic_skill_v1_api_proto = out.File
	file_ai_stigmer_agentic_skill_v1_api_proto_goTypes = nil
	file_ai_stigmer_agentic_skill_v1_api_proto_depIdxs = nil
}
