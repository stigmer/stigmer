...
const file_ai_stigmer_agentic_session_v1_query_proto_rawDesc = "" +
	...
	"\vlistByAgent\x129.ai.stigmer.agentic.session.v1.ListSessionsByAgentRequest\x1a*.ai.stigmer.agentic.session.v1.SessionList\"\x04и\x18\x01\x1a\x04\xa0\xff+*B\x99\x02\n" +
