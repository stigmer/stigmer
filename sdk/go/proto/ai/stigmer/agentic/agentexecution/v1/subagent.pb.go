...
const file_ai_stigmer_agentic_agentexecution_v1_subagent_proto_rawDesc = "" +
	...
	"\x11pending_approvals\x18\x0e \x03(\v25.ai.stigmer.agentic.agentexecution.v1.PendingApprovalR\x10pendingApprovalsB\xcd\x02\n" +
	"(com.ai.stigmer.agentic.agentexecution.v1B\rSubagentProtoP\x01Z]github.com/stigmer/stigmer/sdk/go/proto/ai/stigmer/agentic/agentexecution/v1;agentexecutionv1\xa2\x02\x04ASAA\xaa\x02$Ai.Stigmer.Agentic.Agentexecution.V1\xca\x02$Ai\\Stigmer\\Agentic\\Agentexecution\\V1\xe2\x020Ai\\Stigmer\\Agentic\\Agentexecution\\V1\\GPBMetadata\xea\x02(Ai::Stigmer::Agentic::Agentexecution::V1b\x06proto3"
...
var file_ai_stigmer_agentic_agentexecution_v1_subagent_proto_goTypes = []any{
	...
	(*ToolCall)(nil),          // 3: ai.stigmer.agentic.agentexecution.v1.ToolCall
	(*AgentMessage)(nil),      // 4: ai.stigmer.agentic.agentexecution.v1.AgentMessage
	(*UsageMetrics)(nil),      // 5: ai.stigmer.agentic.agentexecution.v1.UsageMetrics
	(*PendingApproval)(nil),   // 6: ai.stigmer.agentic.agentexecution.v1.PendingApproval
}
var file_ai_stigmer_agentic_agentexecution_v1_subagent_proto_depIdxs = []int32{
	...
	3, // 2: ai.stigmer.agentic.agentexecution.v1.SubAgentExecution.tool_calls:type_name -> ai.stigmer.agentic.agentexecution.v1.ToolCall
	4, // 3: ai.stigmer.agentic.agentexecution.v1.SubAgentExecution.messages:type_name -> ai.stigmer.agentic.agentexecution.v1.AgentMessage
	5, // 4: ai.stigmer.agentic.agentexecution.v1.SubAgentExecution.usage:type_name -> ai.stigmer.agentic.agentexecution.v1.UsageMetrics
	6, // 5: ai.stigmer.agentic.agentexecution.v1.SubAgentExecution.pending_approvals:type_name -> ai.stigmer.agentic.agentexecution.v1.PendingApproval
