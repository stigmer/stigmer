...
const file_ai_stigmer_billing_v1_query_proto_rawDesc = "" +
	...
	"\x19getExecutionBillingSignal\x125.ai.stigmer.billing.v1.GetExecutionBillingSignalInput\x1a8.ai.stigmer.billing.v1.GetExecutionBillingSignalResponse\"I¸\x18E\b\x1d\x10\x1f*6only platform operators can execute billing operations2\astigmerB\xea\x01\n" +
