...
type DeclaredPreferencesInput = gen.DeclaredPreferencesInput
type RecalledMemoriesInput = gen.RecalledMemoriesInput
type RecalledMemoryFactInput = gen.RecalledMemoryFactInput
...
type IdentityAccountPreferencesInput = gen.IdentityAccountPreferencesInput
type IdentityProviderInput = gen.IdentityProviderInput
type InvitationInput = gen.InvitationInput
type LicenseInput = gen.LicenseInput
