...
// SkillClient is NOT aliased here: the handwritten wrapper in skill.go (push routing over the artifact transfer lane, #675) takes the name so client.Skill and the exported type agree.
