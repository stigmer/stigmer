...
const (
	// SDKLanguage is the programming language used for this skill definition
	SDKLanguage = "go"
...
//	    "app.example.com/category": "documentation",
//	}
//	allAnnotations := skill.MergeAnnotations(userAnnotations)
