...
export class AgentExecutionClient {
  ...
  async updateUsage(input: UpdateUsageInput): Promise<UpdateUsageResponse> {
    try {
      return await this.command.updateUsage(input);
    } catch (e) { throw wrapError(e); }
  }
