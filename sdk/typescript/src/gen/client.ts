...
import { AgentRunnerClient } from "./agentrunner";
...
export class GeneratedClient {
  ...
  readonly agentrunner: AgentRunnerClient;
  ...
  constructor(transport: Transport) {
    ...
    this.agentrunner = new AgentRunnerClient(transport);
...
export { AgentRunnerClient } from "./agentrunner";
export { type AgentRunnerInput } from "./agentrunner";
