 ...
 * organization via {@link useCreateOrganization}. The server
 * generates the slug from the provided name.
 *
...
export function CreateOrganizationForm({
  ...
  const handleSubmit = useCallback(
    ...
    [canSubmit, trimmedName, description, create, clearError, onCreated],
  );
