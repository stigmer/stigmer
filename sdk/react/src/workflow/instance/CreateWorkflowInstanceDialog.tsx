    ...
    >
      <form onSubmit={handleSubmit} className="flex flex-col">
        ...
        <div className="flex items-center justify-between border-b border-border px-6 py-4">
          <h2 id="create-instance-title" className="text-base font-semibold text-foreground">
        ...
        <div className="space-y-5 px-6 py-5">
          {/* Name */}
          <div>
            <label htmlFor="instance-name" className="block text-sm font-medium text-foreground mb-1.5">
          ...
          {/* Description */}
          <div>
            <label htmlFor="instance-description" className="block text-sm font-medium text-foreground mb-1.5">
              Description
            </label>
            <textarea
