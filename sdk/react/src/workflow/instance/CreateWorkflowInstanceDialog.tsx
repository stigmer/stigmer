...
export interface CreateWorkflowInstanceDialogProps {
  ...
  readonly onCreated?: (instance: WorkflowInstance) => void;
}
    ...
    >
      <form onSubmit={handleSubmit} className="stg:flex stg:flex-col">
        ...
        <div className="stg:flex stg:items-center stg:justify-between stg:border-b stg:border-border stg:px-6 stg:py-4">
          <h2 id="create-instance-title" className="stg:text-base stg:font-semibold stg:text-foreground">
        ...
        <div className="stg:space-y-5 stg:px-6 stg:py-5">
          {/* Name */}
          <div>
            <label htmlFor="instance-name" className="stg:block stg:text-sm stg:font-medium stg:text-foreground stg:mb-1.5">
            ...
            <input
              ...
              placeholder="e.g. prod-deploy, staging, qa-team"
              disabled={isCreating}
              className={cn(
          ...
          {/* Description */}
          <div>
            <label htmlFor="instance-description" className="stg:block stg:text-sm stg:font-medium stg:text-foreground stg:mb-1.5">
              Description
            </label>
            <textarea
