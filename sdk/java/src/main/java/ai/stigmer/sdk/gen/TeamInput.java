...
import ai.stigmer.iam.team.v1.TeamSpec;

/** Input for creating/updating a Team. */
public final class TeamInput {
    ...
    private TeamInput(Builder builder) {
        this.id = builder.id;
    ...
    Team toProto() {
        TeamSpec.Builder spec = TeamSpec.newBuilder();
    ...
    public static final class Builder {
        ...
        public TeamInput build() { return new TeamInput(this); }
    }
}
