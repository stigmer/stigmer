...
/** Bed level under voiceover scenes; music is glue, never a voice competitor. */
const BED_VOLUME = 0.14;
/** Quieter still under the presenter — her room tone is part of the take. */
const PRESENTER_VOLUME = 0.07;
/** The bed swells when nobody is speaking (the end card's hold). */
const SWELL_VOLUME = 0.42;
