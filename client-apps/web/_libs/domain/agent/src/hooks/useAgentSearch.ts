...
import { useAgentQueryService } from "../services/useAgentQueryService";
...
export function useAgentSearch(options: UseAgentSearchOptions): UseAgentSearchReturn {
  ...
  useEffect(() => {
    ...
    service
      .search({ query: debouncedQuery, org, page: { num: 1, size: pageSize } })
      .then((response) => {
  ...
  }, [debouncedQuery, org, pageSize, service]);

  return { query, setQuery, results, isLoading, error };
}

// ---------------------------------------------------------------------------
// Internal debounce utility
// ---------------------------------------------------------------------------
