...
```bash
npm install @stigmer/agent-execution @stigmer/rpc-client @stigmer/protos @stigmer/theme
```
...
import "@stigmer/agent-execution/styles.css";
...
| Import                                | Contents                                                     |
| ------------------------------------- | ------------------------------------------------------------ |
| `@stigmer/agent-execution`            | All execution components, hooks, helpers                     |
| `@stigmer/agent-execution/styles.css` | Pre-built Tailwind CSS (use without your own Tailwind setup) |
