...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_PENDINGAPPROVAL']._serialized_end=430
  _globals['_CHILDAPPROVALNOTIFICATION']._serialized_start=433
  _globals['_CHILDAPPROVALNOTIFICATION']._serialized_end=595
