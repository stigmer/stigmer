...
class BillingAccount(_message.Message):
    __slots__ = ("id", "org_id", "status", "balance", "auto_recharge", "stripe_customer_id", "allowed_negative_balance_micros", "low_balance_threshold_micros", "created_at", "updated_at")
    ...
    def __init__(self, id: _Optional[str] = ..., org_id: _Optional[str] = ..., status: _Optional[_Union[_enum_pb2.BillingAccountStatus, str]] = ..., balance: _Optional[_Union[CreditBalance, _Mapping]] = ..., auto_recharge: _Optional[_Union[AutoRechargeConfig, _Mapping]] = ..., stripe_customer_id: _Optional[str] = ..., allowed_negative_balance_micros: _Optional[int] = ..., low_balance_threshold_micros: _Optional[int] = ..., created_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., updated_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
