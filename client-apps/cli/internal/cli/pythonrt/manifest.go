...
// Manifest records the immutable state of a bootstrapped runtime environment.
// Written once during bootstrap and checked on subsequent startups to decide
// whether the existing environment is still valid.
...
// IsValid reports whether this manifest represents a runtime that matches the
// given CLI version and a recognized schema.
