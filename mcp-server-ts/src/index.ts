...
import { createServer, serveBoth, serveHttp, serveStdio, isNormalShutdown } from "./server";
import type { BackendTarget } from "./domains/client";

export type { Config, OAuthConfig, Transport } from "./config";
export { loadConfigFromEnv, validateConfig } from "./config";
export { createServer, SERVER_VERSION } from "./server";
