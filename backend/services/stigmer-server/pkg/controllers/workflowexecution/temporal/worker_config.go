...
import (
	...
	"github.com/stigmer/stigmer/backend/services/stigmer-server/pkg/controllers/workflowexecution/temporal/workflows"
...
func NewWorkerConfig(
	...
	return &WorkerConfig{
		config:                   config,
		store:                    store,
		updateStatusActivityImpl: activities.NewUpdateWorkflowExecutionStatusActivityImpl(store),
	}
}
