"""gRPC client for AgentRunner heartbeat reporting."""

from __future__ import annotations

import grpc
from ai.stigmer.agentic.agentrunner.v1 import command_pb2_grpc
from ai.stigmer.agentic.agentrunner.v1.api_pb2 import AgentRunner
...
class AgentRunnerClient:
    ...
    def __init__(
        ...
        *,
        ...
        """Initialize AgentRunner client with authentication.
        ...
        self.stub = command_pb2_grpc.AgentRunnerCommandControllerStub(self.channel)
        self._timeout = timeout

    async def heartbeat(self, input: AgentRunnerHeartbeatInput) -> AgentRunner:
        ...
        Returns:
            The updated AgentRunner resource as persisted by the server.
