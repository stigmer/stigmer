...
# Test script for Golden Test 06: Sleep Delay
# Tests sleep/delay functionality and time-based waits

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
WORKFLOW_FILE="$SCRIPT_DIR/06-sleep-delay.yaml"
GRPC_HOST="${GRPC_HOST:-localhost:9090}"

# Generate unique execution ID
EXECUTION_ID="sleep-delay-$(date +%s)"

echo "======================================"
echo "Golden Test 06: Sleep Delay"
echo "======================================"
...
grpcurl -plaintext -d "{
  ...
  \"metadata\": {
    \"name\": \"Sleep Delay Test\",
    \"version\": \"1.0\",
    \"namespace\": \"golden-tests\",
    \"description\": \"Test sleep and delay functionality\"
  }
...
echo "  1. Execute initial state"
echo "  2. Sleep/delay for configured duration"
echo "  3. Resume execution after delay"
echo ""
