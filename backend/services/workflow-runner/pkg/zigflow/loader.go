...
// LoadFromString loads and validates a workflow from a YAML string
// This is used when workflow YAML is provided via proto input (runtime execution)
func LoadFromString(yamlContent string) (*model.Workflow, error) {
