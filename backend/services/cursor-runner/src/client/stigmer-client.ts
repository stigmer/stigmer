...
export class StigmerClient {
  ...
  /**
   * Trigger the connect RPC: discover tools and classify approval policies.
   *
   * Mirrors the Python agent-runner's McpServerClient.connect().
   * Blocks until the backend's discovery + classification workflow completes.
   */
