...
The Rust host (`client-apps/desktop/src-tauri/src/runner.rs`) and the Go harness
(`test/integration/harness/unified_runner.go`) are hand-maintained mirrors that
