...
// The prefix's one home is `shared/tool-rounds.ts` since S3 M1 (the runtime's
// `toolCallLimitArm` reads it there); this module composes today's message
// from it until M2b retires the module with its orchestrator.
