/**
 * PlatformClient token flow playback — end-to-end visualization
 * of how a platform builder mints user tokens and how Stigmer
 * validates them.
 *
 * Uses three view types (BrowserView, TerminalView, APIExchangeView)
 * to visually distinguish the platform builder's app, the backend
 * call to Stigmer, and Stigmer's internal validation pipeline.
 */
