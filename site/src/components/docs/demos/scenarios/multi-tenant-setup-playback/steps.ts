/**
 * Multi-tenant setup playback — walkthrough of the two-phase
 * multi-tenant onboarding flow: tenant org creation followed by
 * per-tenant user provisioning and access grant.
 *
