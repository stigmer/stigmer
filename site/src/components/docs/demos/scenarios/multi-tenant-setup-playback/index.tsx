    ...
    <div className="flex h-full flex-col bg-gradient-to-b from-background to-muted/30">
      <div className="border-b border-border px-4 py-2.5">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-[9px] text-muted-foreground">/ Tenants</span>
        </div>
      </div>
      ...
      <div className="flex-1 p-4">
        ...
        <div className="space-y-1.5">
          <div className="flex items-center gap-2 rounded-md border border-primary/30 bg-primary/5 px-3 py-2">
            ...
            <span className="ml-auto rounded-full bg-amber-500/10 px-1.5 py-0.5 text-[7px] font-medium text-amber-600">
              Provisioning...
            </span>
          </div>
          <div className="flex items-center gap-2 rounded-md border border-border px-3 py-2">
            ...
            <span className="ml-auto rounded-full bg-emerald-500/10 px-1.5 py-0.5 text-[7px] font-medium text-emerald-600">
              Active
            </span>
          </div>
          <div className="flex items-center gap-2 rounded-md border border-border px-3 py-2">
...
export function MultiTenantSetupPlayback() {
  ...
  const handleStepChange = useCallback((step: MultiTenantSetupStep) => {
