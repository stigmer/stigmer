...
**Last Session**: 2026-04-04 — T03 complete (MDX generator), all 17 domain pages generated and rendering
**Current Task**: T04 (sidebar + overview links) / T05 (TSDoc backfill) — can run in parallel
**Status**: T01 COMPLETE, T02 COMPLETE, T03 COMPLETE, T04+T05 next
...
1. **T04**: Update the overview page (`docs/sdk/react/index.mdx`) — replace "planned" text with links to generated domain pages, update "What's next" cards
2. **T05**: TSDoc backfill for under-documented interfaces (session, execution, agent, composer, core domains prioritized)

## Quick Commands

After loading context:
- "Continue with T04" - Wire sidebar and overview links
- "Continue with T05" - Start TSDoc backfill
